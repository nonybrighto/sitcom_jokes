...
class _$UserSerializer implements StructuredSerializer<User> {
  ...
  Iterable serialize(Serializers serializers, User object,
    ...
    final result = <Object>[
      ...
      'profileIconUrl',
      serializers.serialize(object.profileIconUrl,
...
class _$User extends User {
  ...
  _$User._({this.id, this.name, this.profileIconUrl}) : super._() {
    if (id == null) {
    ...
    if (profileIconUrl == null) {
      throw new BuiltValueNullFieldError('User', 'profileIconUrl');
    }
  }
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, id.hashCode), name.hashCode), profileIconUrl.hashCode));
  }
...
class UserBuilder implements Builder<User, UserBuilder> {
  ...
  _$User build() {
    final _$result =
        _$v ?? new _$User._(id: id, name: name, profileIconUrl: profileIconUrl);
    replace(_$result);
    return _$result;
  }
}
